...
# configure our projects to store all our images inside static/images
...
def addproducts():
    ...
    connection.commit()
    return jsonify({"message":"Products details added successful"})
...
def mpesa_payment():
    if request.method == 'POST':
        ...
        "AccountReference": " farasi SokoGarden Online",
